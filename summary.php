...
$PAGE->set_url('/local/qrsub/summary.php', array('attempt' => $attemptid));
...
$output = $PAGE->get_renderer('local_qrsub');
...
$html = $output->summary_page($attemptobj, $displayoptions);
$url = str_replace('/mod/quiz/', '/local/qrsub/', $html);
echo $url;
